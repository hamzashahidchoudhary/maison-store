...
export default function HomePage() {
  ...
  return (
    <div className="home-page">
      ...
      >
        {/* One <img> per category; active one fades in */}
        {CATEGORIES.map((cat) => (
          <img
            key={cat.id}
            src={cat.image}
        ...
        >
          <p
            style={{
              ...
              color: activeCategory.lightBg ? '#555' : 'rgba(255,255,255,0.65)',
              marginBottom: '1rem',
              transition: 'color 0.5s ease',
            }}
          >
            Maison — Curated Living
          </p>
          ...
          <p
            style={{
              ...
              maxWidth: '520px',
              lineHeight: 1.7,
              color: activeCategory.lightBg ? '#555' : 'rgba(255,255,255,0.75)',
              marginBottom: '2.5rem',
              transition: 'color 0.5s ease',
            }}
          >
          ...
          <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', justifyContent: 'center' }}>
            <Link
              ...
              style={{
                ...
                backgroundColor: activeCategory.lightBg ? '#1a1a1a' : '#ffffff',
                color: activeCategory.lightBg ? '#ffffff' : '#1a1a1a',
                textDecoration: 'none',
                fontSize: '0.78rem',
            ...
            <Link
              ...
              style={{
                padding: '0.9rem 2.5rem',
                border: `1px solid ${activeCategory.lightBg ? '#1a1a1a' : '#ffffff'}`,
                color: activeCategory.lightBg ? '#1a1a1a' : '#ffffff',
                textDecoration: 'none',
                fontSize: '0.78rem',
                letterSpacing: '0.15em',
          ...
          >
            {CATEGORIES.map((cat) => (
              <button
                ...
                title={cat.name}
                style={{
                  width: activeCategory.id === cat.id ? '2.2rem' : '0.55rem',
                  height: '0.55rem',
                  borderRadius: '999px',
                  backgroundColor: activeCategory.lightBg
